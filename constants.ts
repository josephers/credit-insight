...
export const DEFAULT_TERMS: StandardTerm[] = [
  ...
  { id: 'gen_6', name: 'Incremental Facilities', description: 'Accordion features to increase facility size', category: 'General' },
  { id: 'gen_7', name: 'Letter of Credit Sublimit', description: 'Maximum amount available for L/Cs', category: 'General' },
  { id: 'gen_8', name: 'Mandatory Prepayments', description: 'Triggers: Excess Cash Flow, Asset Sales, Debt Issuance', category: 'General' },
  ...
  { id: 'fin_3', name: 'Fixed Charge Coverage Ratio', description: 'Min FCCR (EBITDA-Capex / Fixed Charges)', category: 'Financial' },
  { id: 'fin_4', name: 'Senior Net Leverage Ratio', description: 'Max Senior Secured Net Leverage', category: 'Financial' },
  { id: 'fin_5', name: 'Capital Expenditures', description: 'Limits on annual Capex', category: 'Financial' },
  ...
  { id: 'cov_7', name: 'Fundamental Changes', description: 'Restrictions on mergers, consolidations, liquidations', category: 'Covenants' },
  { id: 'cov_8', name: 'Burdensome Agreements', description: 'Restrictions on subsidiaries ability to pay dividends', category: 'Covenants' },
  ...
  { id: 'bsk_6', name: 'Unlimited RP Threshold', description: 'Leverage level permitting unlimited dividends', category: 'Baskets' },
  ...
  { id: 'def_3', name: 'Change of Control', description: 'Definition of ownership change triggers', category: 'Definitions' },
  { id: 'def_4', name: 'Material Adverse Effect', description: 'Definition of MAE conditions', category: 'Definitions' },
...
export const MARKET_BENCHMARK = {
  ...
  'Senior Net Leverage Ratio': '3.00x',
  ...
  'Mandatory Prepayments': '50% ECF with step-downs; 100% Asset Sales',
  'Incremental Facilities': 'Free and Clear + Ratio Debt',
  'Change of Control': 'Acquisition of >35% ownership'
};
...
export const DEFAULT_BENCHMARK_PROFILES: BenchmarkProfile[] = [
  ...
  },
  {
    ...
    data: {
      ...
      'Mandatory Prepayments': '75% ECF with step-downs'
    }
  },
  {
    id: 'canada_standard',
